...
## When the work came from an agent

Do not fold from its summary. Load the **verifying-agent-work** skill — diff, transcript, and
re-execution — before treating delegated changes as real.
