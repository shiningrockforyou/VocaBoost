...
- **runId:** `mig-r18`  **mode:** `full-dry`
- **git:** `a967f54` (HEAD `a967f544e0f3d4bce72861ad82a34d8e2ec27206`) dirty=true (368 paths)
...
| ⛔ | RUN-dual | migration --dry (dual) | a --dry report | NO REPORT (exit 1) | **INVALID** | dry |
| ⛔ | RUN-div | migration --dry (div) | a --dry report | NO REPORT (exit 1) | **INVALID** | dry |
| ⛔ | RUN-rog | migration --dry (rog) | a --dry report | NO REPORT (exit 1) | **INVALID** | dry |
| ⛔ | RUN-forge | migration --dry (forge) | a --dry report | NO REPORT (exit 1) | **INVALID** | dry |
| ⛔ | RUN-race | migration --dry (race) | a --dry report | NO REPORT (exit 1) | **INVALID** | dry |
| ⛔ | RUN-single | migration --dry (single) | a --dry report | NO REPORT (exit 1) | **INVALID** | dry |
| ✅ | SANDBOX-GUARD | independent per-doc sandbox re-verify of the --dry plan | every enumerated doc 25WT + lsr_*@vocaboost.test | 0 docs verified sandbox | **PASS** | dry |
| ⛔ | MIG-1 | LIVE-STRAND collapse | merged twi == cross-class anchor 640; LIVE-STRAND; MIGRATE | pair absent from plan | **INVALID** | dry |
| ⛔ | MIG-2 | divergent + own-anchor CSD screen | twi==640(fast), csd==15(slow), not quarantined | pair absent | **INVALID** | dry |
| ⛔ | MIG-3 | review-only CSD evidence amendment | MIGRATE; csd==13 preserved (not demoted to 3); A6 clean | pair absent | **INVALID** | dry |
| ⛔ | MIG-4 | forged/anchorless → QUARANTINE (dry leg) | SKIP_QUARANTINE + ANCHORLESS_TWI + never zeroed/promoted; legacy retained | pair absent | **INVALID** | dry |
| ⛔ | MIG-5 | single-doc 1:1 re-key | verbatim csd==5/twi==200; single-doc; 0 deviations | pair absent | **INVALID** | dry |
| ✅ | MIG-9 | cohort hard asserts (dry leg) | A1/A2 empty cohort-wide; --dry diff artifact per uid; migrationVersion stamp | twiRegressions=0 csdRegressions=0 artifacts=0 migVer_ok=true | **PASS** | dry |
...
- **RUN-dual** (INVALID, dry): list-progress.mjs:146:68     at ModuleJob.run (node:internal/modules/esm/module_job:377:25)     at async onImport.tracePromise.__proto__ (node:internal/modules/esm/loader:671:26)     at async asyncRunEntryPointWithESMLoader (node:internal/modules/run_main:101:5) {   errno: -4058,   code: 'ENOENT',   syscall: 'open',   path: 'C:\\app\\scripts\\serviceAccountKey.json' }  Node.js v24.11.1 
- **RUN-div** (INVALID, dry): list-progress.mjs:146:68     at ModuleJob.run (node:internal/modules/esm/module_job:377:25)     at async onImport.tracePromise.__proto__ (node:internal/modules/esm/loader:671:26)     at async asyncRunEntryPointWithESMLoader (node:internal/modules/run_main:101:5) {   errno: -4058,   code: 'ENOENT',   syscall: 'open',   path: 'C:\\app\\scripts\\serviceAccountKey.json' }  Node.js v24.11.1 
- **RUN-rog** (INVALID, dry): list-progress.mjs:146:68     at ModuleJob.run (node:internal/modules/esm/module_job:377:25)     at async onImport.tracePromise.__proto__ (node:internal/modules/esm/loader:671:26)     at async asyncRunEntryPointWithESMLoader (node:internal/modules/run_main:101:5) {   errno: -4058,   code: 'ENOENT',   syscall: 'open',   path: 'C:\\app\\scripts\\serviceAccountKey.json' }  Node.js v24.11.1 
- **RUN-forge** (INVALID, dry): list-progress.mjs:146:68     at ModuleJob.run (node:internal/modules/esm/module_job:377:25)     at async onImport.tracePromise.__proto__ (node:internal/modules/esm/loader:671:26)     at async asyncRunEntryPointWithESMLoader (node:internal/modules/run_main:101:5) {   errno: -4058,   code: 'ENOENT',   syscall: 'open',   path: 'C:\\app\\scripts\\serviceAccountKey.json' }  Node.js v24.11.1 
- **RUN-race** (INVALID, dry): list-progress.mjs:146:68     at ModuleJob.run (node:internal/modules/esm/module_job:377:25)     at async onImport.tracePromise.__proto__ (node:internal/modules/esm/loader:671:26)     at async asyncRunEntryPointWithESMLoader (node:internal/modules/run_main:101:5) {   errno: -4058,   code: 'ENOENT',   syscall: 'open',   path: 'C:\\app\\scripts\\serviceAccountKey.json' }  Node.js v24.11.1 
- **RUN-single** (INVALID, dry): list-progress.mjs:146:68     at ModuleJob.run (node:internal/modules/esm/module_job:377:25)     at async onImport.tracePromise.__proto__ (node:internal/modules/esm/loader:671:26)     at async asyncRunEntryPointWithESMLoader (node:internal/modules/run_main:101:5) {   errno: -4058,   code: 'ENOENT',   syscall: 'open',   path: 'C:\\app\\scripts\\serviceAccountKey.json' }  Node.js v24.11.1 
- **SANDBOX-GUARD** (PASS, dry): all 0 source docs re-read as 25WT + lsr_*
- **MIG-1** (INVALID, dry): seed did not materialize / not enumerated
- **MIG-2** (INVALID, dry): seed did not materialize
- **MIG-3** (INVALID, dry): seed did not materialize
- **MIG-4** (INVALID, dry): seed did not materialize
- **MIG-5** (INVALID, dry): seed did not materialize
