...
- **runId:** `p7final`  **target:** `baseline`
- **git:** `a967f54` (HEAD `a967f544e0f3d4bce72861ad82a34d8e2ec27206`) dirty=true (301 paths)
- **dist:** local dist/ built 2026-07-14T06:30:32.384Z (NOT the deployed bundle; freshness unverified)
- **flag files dirty:** M functions/index.js, M src/config/featureFlags.js, ?? functions/foundation.js
- **run:** 2026-07-14T07:10:43.583Z
...
- **DG-4b** (PASS): local dist/ built 2026-07-14T06:30:32.384Z (NOT the deployed bundle; freshness unverified). "Please Reload" in 1 dist asset(s); audit/scripts refs in 0.
...
- **CUT-1b** (PASS): local dist/ built 2026-07-14T06:30:32.384Z (NOT the deployed bundle; freshness unverified). class_progress in 6 dist asset(s) — expected present in baseline (goes 0 only after P4 cutover + P7 retire).
- **RET-1** (PASS): class_progress refs: 90 (src=41 functions=13 scripts/cs=36). Nothing retired in baseline.
