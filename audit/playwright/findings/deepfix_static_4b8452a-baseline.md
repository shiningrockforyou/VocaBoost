...
- **runId:** `4b8452a-baseline`  **target:** `baseline`
- **git:** `4b8452a` (HEAD `4b8452aa7581f2758ec53ee4f3a89f2693122094`) dirty=true (107 paths)
- **dist:** local dist/ built 2026-07-14T09:12:20.509Z (NOT the deployed bundle; freshness unverified)
- **flag files dirty:** M functions/foundation.js, M functions/index.js, M src/config/featureFlags.js
- **run:** 2026-07-17T18:45:47.944Z

**FINAL: NOT_CLEAN** target=baseline pass=38 fail=3 invalid=0 skip=2
...
| ❌ | DG-1:REVIEW_PAIRING_V2 | DG-1 | false | true | **FAIL** |
| ❌ | DG-1:REENTRY_GUARD | DG-1 | false | true | **FAIL** |
| ❌ | DG-1:RECOVERY_GUARD | DG-1 | false | true | **FAIL** |
...
| ✅ | DG-1:REVIEW_ENGAGEMENT_STAMP_ENABLED | DG-1 | false | false | **PASS** |
| ✅ | DG-1:RECOVERY_SCORE_CLAMP_ENABLED | DG-1 | false | false | **PASS** |
...
- **DG-1:REVIEW_PAIRING_V2** (FAIL): src/config/featureFlags.js declares REVIEW_PAIRING_V2=true. Source: CS PR-1 · WI-2 (CS_2026-07-17_ROOT_CAUSE_EFFORT) — census-LOCKED I4 pairing predicate + 8→12 window; dormant until the PR-1 flip
- **DG-1:REENTRY_GUARD** (FAIL): src/config/featureFlags.js declares REENTRY_GUARD=true. Source: CS PR-1 · WI-3 + F2 (CS_2026-07-17_ROOT_CAUSE_EFFORT) — I3 re-entry day-guard + retake queue + under-answered review confirm; dormant until the PR-1 flip
- **DG-1:RECOVERY_GUARD** (FAIL): src/config/featureFlags.js declares RECOVERY_GUARD=true. Source: CS PR-1 · WI-4 client (CS_2026-07-17_ROOT_CAUSE_EFFORT) — I6 recovery answer intersection; dormant until the PR-1 flip
...
- **DG-1:REVIEW_ENGAGEMENT_STAMP_ENABLED** (PASS): functions/foundation.js declares REVIEW_ENGAGEMENT_STAMP_ENABLED=false. Source: CS PR-2 F3 — additive review-engagement stamp; dormant in tree, flips TRUE at the D2 functions deploy
- **DG-1:RECOVERY_SCORE_CLAMP_ENABLED** (PASS): functions/foundation.js declares RECOVERY_SCORE_CLAMP_ENABLED=false. Source: CS PR-2 WI-4/I6 — server >100% score clamp; dormant in tree, flips TRUE at the D2 functions deploy
...
- **DG-4** (PASS): commits: src/services/studyService.js→4b8452a deepfix: full working tree at initial-release GO (P0–P10 staged, Codex-converged) \| src/pages/DailySessionFlow.jsx→4b8452a deepfix: full working tree at initial-release GO (P0–P10 staged, Codex-converged) \| src/pages/Dashboard.jsx→4b8452a deepfix: full working tree at initial-release GO (P0–P10 staged, Codex-converged). fix-unique "Please Reload" ×1 in TypedTest.jsx (full: "Couldn't Grade — Please Reload"). audit/scripts imports from src: none.
...
- **RET-1** (PASS): class_progress refs: 123 (src=44 functions=13 scripts/cs=66). Nothing retired in baseline.
