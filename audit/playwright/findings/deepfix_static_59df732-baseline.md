...
- **runId:** `59df732-baseline`  **target:** `baseline`
- **git:** `59df732` (HEAD `59df732657dfb742d4392a47ae5c1d988377387a`) dirty=true (58 paths)
...
| ✅ | DG-1:FORCED_PATHWAY | DG-1 | false | false | **PASS** |
...
- **DG-1:FORCED_PATHWAY** (PASS): src/config/featureFlags.js declares FORCED_PATHWAY=false. Source: CS PR-3 · WI-1 — binary throttle + hold-csd + F3 grandfathered engagement (client leg); DORMANT at merge, HARD-GATED behind the live PR-1 flip; flips true after the PR-1 soak
