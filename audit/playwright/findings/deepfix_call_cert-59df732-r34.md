...
- **git:** `59df732` (HEAD `59df732657dfb742d4392a47ae5c1d988377387a`) dirty=true (30 paths)
- **firestore.rules sha256:** `null`
- **run:** 2026-07-17T20:04:32.719Z
...
| PASS | CS-5 | markReviewComplete W2 upgraded: parseable testId + integer nwsi/nwei == day anchor (pairable) | testId parseable + nwsi/nwei==(20,39) + autoCompleted server marker | testId=vocaboost_test_25WTcert59df732r34cs5_lsrlistcert59df732r34cs5_review range=(20,39) writtenBy=cloud-function | **PASS** |
...
| PASS | OV-1 | overrideAttempt writes a FULL VALID anchor (nwsi/nwei/wordsIntroduced/testId) + day advances | valid anchor written (manual-pass parity) + teacher_override audit log | anchorFields=(80,159) testId=vocaboost_test_25WTcert59df732r34ov1_lsrlistcert59df732r34ov1_new passed=true log=true | **PASS** |
