...
- **runId:** `d2bb2bc-baseline`  **target:** `baseline`
- **git:** `d2bb2bc` (HEAD `d2bb2bc90e356886707007bd18852906c2062df7`) dirty=true (18 paths)
...
| ✅ | DG-1:FORCED_PATHWAY_ENABLED | DG-1 | true | true | **PASS** |
