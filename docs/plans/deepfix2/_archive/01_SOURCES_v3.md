...
| `docs/plans/loop/handoffs/claude_to_codex_deepfix2_r41.md` + `_r42.md` (+ r43 when raised) | The Codex handoffs; reviews at `codex_reviews/codex_deepfix2_r41.md`/`_r42.md` |
...
4. `deepfix2/06_MESSAGING_COPY.md` — the register's actual bilingual (ko/en) copy (15 rows + row 16), reviewed before
   build; **supersedes §12.3's draft strings** [Fable-2 M5]. **(DF2-07/DF2-32)**
